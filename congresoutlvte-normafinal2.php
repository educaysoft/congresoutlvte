...
<p style="font-size: 30px; font-weight: bold; text-align: center; padding: 20px 0 40px 0; "> PLANTILLA PARA EVALUAR EL ARTÍCULO.</p>


<div style="width: 100%;padding:10px;" > <center><a href="Documentos/FormularioEvaluacionPonencias.pdf"><button class="button-33" role="button">Desargar</button></a>
</center></div>
