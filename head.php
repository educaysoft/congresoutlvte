...
<div   id="intro-example"  class="p-5 text-center bg-image"     style="background-image: url('http://congresoutlvte.org/faci/images/portada1.jpg');" >
	<div class="mask" style="background-color:hsla(120,100%,50%,0.0)">
       <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-black">
           ...
           <p class="mb-4 bg-light" style="font-family: Franklin Gothic Medium,Franklin Gothic,ITC Franklin Gothic,Arial,sans-serif; color: white;font-weight:800; font-size:1.5em; text-shadow: 2px 2px #000000;" > UNA MIRADA HACIA LAS CIENCIAS DE INGENIEROS E INGENIERAS</p>
