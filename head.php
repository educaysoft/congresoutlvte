...
<a class="navbar-brand" href=" href="https://www.utelvt.edu.ec/site/" target="_blank">
...
<div   id="intro-example"  class="p-5 text-center bg-image"     style="background-size:100% auto;background-position:center top; background-image: url('http://congresoutlvte.org/faci/images/portada2.jpg');" >
	<div class="mask" style="background-color:hsla(120,100%,50%,0.0)">
       <div class="d-flex justify-content-center align-items-center h-100">
        ...
        <p class="mb-5" style=" color: white; font-weight:900;font-size:1.17em;text-shadow: 2px 2px #000000;">   Noviembre 7,8,9 - 2022 <br> Esmeraldas-Ecuador  </p>
