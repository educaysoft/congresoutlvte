...
<div style="border-top:2px solid green;margin-top: 10px;">
  <div style="width: 100%;height: 200px;  padding:20px; display:flex; justify-content:  space-between;">  
   ...
   <div style=" padding:0.5vw; position: relative;width:10%;bottom: 0;">
   <div style="position:absolute; bottom: 0;height: 100%; display:flex; flex-direction: column ; justify-content: end;">    
      <img src="images/mexico.png" width="100%" >
      <span><p>México</p></span>
   </div>
   </div>
   ...
   <div style="position:absolute; bottom: 0;width: 100%;">    
      ...
      <img src="images/venezuela.png" width="100%" >
      <center><p>Venezuela</p></center>
    </div>
    </div>
   ...
   <div style=" padding:0.5vw; position: relative; width:10%;  ">
   <div style="position:absolute; bottom: 0;height: 100%; display:flex; flex-direction: column ; justify-content: end;">    
      <img src="images/cuba.png" width="100%">
      <span><p>Cuba</p></span>
    </div>
    </div>
   ...
   <div style=" padding:0.5vw; position: relative ;width:10%;">
   <div style="position:absolute; bottom: 0;width: 100%;">    
      <img src="images/Angola.png" width ="100%">
      <center><p>Angola</p></center>
    </div>
    </div>
